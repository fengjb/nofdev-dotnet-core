...
namespace Nofdev.Data.Extensions
{
    ...
    public static class StringExtensions
    {
        ...
        {
            return EnsureEndsWith(str, c, NofdevStringComparison.InvariantCulture);
        }

        /// <summary>
        /// Adds a char to end of given string if it does not ends with the char.
        /// </summary>
        public static string EnsureEndsWith(this string str, char c, NofdevStringComparison comparisonType)
        {
            if (str == null)
            {
        ...
        {
            return EnsureStartsWith(str, c, NofdevStringComparison.InvariantCulture);
        }

        /// <summary>
        /// Adds a char to beginning of given string if it does not starts with the char.
        /// </summary>
        public static string EnsureStartsWith(this string str, char c, NofdevStringComparison comparisonType)
        {
            if (str == null)
            {
                throw new ArgumentNullException("str");
